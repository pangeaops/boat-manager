    ...
    <div className="space-y-10 relative">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <button 
          ...
          className="bg-[#ffb519] text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl hover:scale-105 transition-transform cursor-pointer relative z-10"
        >
          Add Stock Item
        </button>
      </header>
              ...
              >
                ...
                <div className="flex justify-between items-start">
                   ...
                   <button 
                    ...
                    className="w-8 h-8 rounded-full bg-slate-50 text-slate-400 flex items-center justify-center text-xs opacity-0 group-hover:opacity-100 transition-opacity hover:bg-amber-100 hover:text-amber-600 cursor-pointer"
                   >
                     ✏️
                   </button>
                </div>
                ...
                <div className="flex items-end justify-between pt-4 border-t border-slate-100">
                   ...
                   <div className="flex space-x-2">
                      <button 
                        ...
                        className="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center font-black hover:bg-red-600 hover:text-white transition-all shadow-sm cursor-pointer"
                      >-</button>
                      <button 
                        type="button"
                        onClick={() => onUpdateInventory({...item, currentStock: item.currentStock + 1})}
                        className="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center font-black hover:bg-green-600 hover:text-white transition-all shadow-sm cursor-pointer"
                      >+</button>
                   </div>
                </div>
              </div>
